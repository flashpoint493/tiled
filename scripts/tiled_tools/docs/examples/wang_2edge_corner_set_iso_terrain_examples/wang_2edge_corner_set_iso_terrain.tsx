...
<tileset version="1.10" tiledversion="1.11" name="wang_2edge_corner_iso_terrain_sand_water" tilewidth="128" tileheight="128" tilecount="32" columns="8">
 <tileoffset x="0" y="32"/>
 <grid orientation="isometric" width="128" height="64"/>
 <image source="wang_2edge_corner_set_iso_terrain.png" width="1024" height="512"/>
 <tile id="0">
  <properties>
 ...
 <wangsets>
  <wangset name="edge_set" type="edge" tile="15">
   ...
   <wangtile tileid="1" wangid="1,0,1,0,1,0,2,0"/>
   <wangtile tileid="2" wangid="2,0,1,0,1,0,1,0"/>
   <wangtile tileid="3" wangid="2,0,1,0,1,0,2,0"/>
   <wangtile tileid="4" wangid="1,0,2,0,1,0,1,0"/>
   <wangtile tileid="5" wangid="1,0,2,0,1,0,2,0"/>
   <wangtile tileid="6" wangid="2,0,2,0,1,0,1,0"/>
   <wangtile tileid="7" wangid="2,0,2,0,1,0,2,0"/>
   <wangtile tileid="8" wangid="1,0,1,0,2,0,1,0"/>
   <wangtile tileid="9" wangid="1,0,1,0,2,0,2,0"/>
   <wangtile tileid="10" wangid="2,0,1,0,2,0,1,0"/>
   <wangtile tileid="11" wangid="2,0,1,0,2,0,2,0"/>
   <wangtile tileid="12" wangid="1,0,2,0,2,0,1,0"/>
   <wangtile tileid="13" wangid="1,0,2,0,2,0,2,0"/>
  ...
  <wangset name="corner_set" type="corner" tile="31">
   ...
   <wangtile tileid="21" wangid="0,2,0,1,0,2,0,1"/>
